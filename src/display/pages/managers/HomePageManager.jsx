...
export default function HomePageManager() {
    ...
    return (
        <HomePage getHebrewDates={getHebrewDates} getTimeSlots={getTimeSlots} dates={dates} timeSlots={timeSlots} selectedDate={selectedDate} setSelectedDate={setSelectedDate} isOpen={isOpen} setIsOpen={setIsOpen} />
    )
}
